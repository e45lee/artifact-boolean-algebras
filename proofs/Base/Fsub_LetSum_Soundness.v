...
Require Export Fsub.Base.Fsub_LetSum_Lemmas.
...
Lemma typing_inv_int : forall E n P T,
  typing E (exp_int P n) T ->
...
Proof with simpl_env; eauto.
  ...
  Case "typing_upqual".
    inversion Red; subst...
    SCase "red_upqual_int".
      unshelve epose proof (typing_inv_int
        _ _ _ _ Typ Q T _) as [? ?].
...
Lemma canonical_form_int : forall e Q,
  value e ->
  typing empty e (qtyp_qtyp Q typ_int) ->
...
Proof with eauto.
    ...
    SCase "Val1".
      ...
      SSCase "red_int".
        ...
        unshelve epose proof
          (typing_inv_int _ _ _ _ Typ Q T _) as [? ?]...
          eapply subqtype_reflexivity...
        unshelve epose proof (
          wf_empty_subqual_evaluates P0 _) as [C Eq]...
      SSCase "red_exp_abs".
    ...
    SCase "Val1".
      ...
      inversion Val1; subst...
        ...
        unshelve epose proof (
          wf_empty_subqual_evaluates P0 _) as [C Eq]...
        econstructor...
        eapply subqual_implies_compatible with (P := P0) (Q := P)...
        eapply subqual_transitivity with (Q := Q)...
      SSCase "red_exp_abs".
        inversion select (expr (exp_abs _ _ _)); subst...
  ...
  SCase "typing_if0".
    right.
    destruct IHTyp1 as [Val1 | [e' Rede']]...
    unshelve epose proof (canonical_form_int _ _ _ Typ1) as [P [n Eq]]; subst...
    unshelve epose proof (typing_regular _ _ _ Typ1) as [WfE [Expr WfQTyp]]...
